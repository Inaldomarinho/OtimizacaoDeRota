...
grafo.ligarNos(1,0,100,0)
grafo.ligarNos(200,200,100,0)


# Coloca o no de inicio e fim nas funcoes grafo.index(x,y)
INICIO = grafo.grafo[grafo.posicao(1, 0)]
FINAL = grafo.grafo[grafo.posicao(200, 200)]
